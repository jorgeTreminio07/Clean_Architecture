...
namespace MyApp.Infrastructure.Migrations
{
    ...
    public partial class Dbinit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ClaseEntityEstudianteEntity",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClaseEntityEstudianteEntity", x => new { x.ClaseId, x.EstudianteId });
                    table.ForeignKey(
                        name: "FK_ClaseEntityEstudianteEntity_Clase_ClaseId",
                        column: x => x.ClaseId,
                        principalTable: "Clase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClaseEntityEstudianteEntity_Estudiante_EstudianteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClaseEntityEstudianteEntity_EstudianteId",
